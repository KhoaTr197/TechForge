...
namespace TechForgeDAO
{
    public class DoanhThuDAO : BaseDAO
    {
        ...
        {
            doanhthuDTO.SoNgay = this.GetNumberOfDays(doanhthuDTO);
            doanhthuDTO.SoHoiVien = this.GetNumberOfMembers();
            doanhthuDTO.SoNCC = this.GetNumberOfSuppliers();
            doanhthuDTO.SoSanPham = this.GetNumberOfProducts();
            doanhthuDTO.SoHoaDon = this.GetNumberOfOrders(doanhthuDTO);
            doanhthuDTO.SPBanChayList = this.GetTopProductsList(doanhthuDTO);
            doanhthuDTO.SPTonKhoList = this.GetUndestockList();
            doanhthuDTO.DoanhThuList = this.GetRevenueList(doanhthuDTO);
        }
